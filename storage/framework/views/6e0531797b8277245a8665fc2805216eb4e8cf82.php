                  ...
                  <div id="accountAlert" class="text-xs mt-2"><p style="font-weight: 500; font-size:0.9rem;">You are registering as an Client</p></div>
                   <div id="radio-btn">
                    ...
                    <label class="block mb-8">
                        <input id="full_name" type="text" class="h-10 form-input mt-2 block w-full <?php $__errorArgs = ['full_name'];
...
unset($__errorArgs, $__bag); ?>" name="full_name" value="<?php echo e(old('full_name')); ?>" required autofocus placeholder="Preferred Name" style="border:1px solid #999; padding:25px 15px;">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Project\datingapp\levana\resources\views/auth/register.blade.php ENDPATH**/ ?>