...
unset($__errorArgs, $__bag); ?>
                  ...
                  <label class="block mb-2">
                      <input id="password-confirm" type="password" class="h-10 form-input mt-2 block w-full " name="password_confirmation" required autocomplete= "new-password" placeholder="Confirm Password" style="border:1px solid #999; padding:25px 15px;">
                                ...
                                <input id="gender1" type="radio" name="gender" value="Male" style="font-family: 'Poppins', sans-serif; border:1px solid #999; padding:25px 15px; width: 15px !important; margin-top:0px !important;"><span style="float: left; font-family: 'Poppins', sans-serif; font-size: 1rem;">Male</span>
                                <input id="gender2" type="radio" name="gender" value="Transsexual" style="font-family: 'Poppins', sans-serif; border:1px solid #999; padding:25px 15px; width: 15px !important; margin-top:0px !important;"><span style=" font-family: 'Poppins', sans-serif;float: left;font-size: 1rem;">Transsexual</span>
                                <input id="gender3" type="radio" name="gender" value="Female" style="font-family: 'Poppins', sans-serif; border:1px solid #999; padding:25px 15px; width: 15px !important; margin-top:0px !important;"><span style=" font-family: 'Poppins', sans-serif;float: left;font-size: 1rem;">Female</span>
                            </div>
                        </label>
                        <div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Projects\Laravel-dating-site\resources\views/auth/register.blade.php ENDPATH**/ ?>