...
unset($__errorArgs, $__bag); ?>
                  ...
                  <label class="block mb-8 mt-3" id="gender-selection" style="display: none; ">
                        <div style="display: flex;justify-content: space-between;margin: 10px;align-items: center;flex-direction: row;
                            ...
                            <input id="gender1" type="radio" class="h-5 form-input mt-2 " name="gender" value="male" style="font-family: 'Poppins', sans-serif; border:1px solid #999; padding:25px 15px; margin-top:0px !important;"><span style="float: left; color: #3506f1;  font-family: 'Poppins', sans-serif; font-size: 1rem;">Male</span>
                            <input id="gender2" type="radio" class="h-5 form-input mt-2 " name="gender" value="trans" style="font-family: 'Poppins', sans-serif; border:1px solid #999; padding:25px 15px; margin-top:0px !important;"><span style=" font-family: 'Poppins', sans-serif;float: left;font-size: 1rem;">Transsexual</span>
                            <input id="gender3" type="radio" class="h-5 form-input mt-2 " name="gender" value="female" style="font-family: 'Poppins', sans-serif; border:1px solid #999; padding:25px 15px; margin-top:0px !important;"><span style="color: #ed4899; font-family: 'Poppins', sans-serif;float: left;font-size: 1rem;">Female</span>
                        </div>
                    </label>
                  <div>
...
//            if(type=='brand') registerToggle('brand');
//            }
