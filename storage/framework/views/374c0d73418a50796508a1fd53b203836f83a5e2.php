...
unset($__errorArgs, $__bag); ?>" name="password" required autocomplete="current-password" placeholder="Password" style="border:1px solid #999; padding: 25px 15px;">
                          ...
                          <div>
                                <label class="flex items-center">
                                    <?php if(Route::has('password.request')): ?>
                                        <a class="text-sm text-yellow-500" href="<?php echo e(route('password.request')); ?>">
                      ...
                      <div class="flex mt-6 w-2/3 mx-auto">
                          <button type="submit" class="w-full appearance-none text-white text-lg md:text-xl font-semibold tracking-wide rounded bg-yellow-500" style="padding:15px;"> <?php echo e(__('Sign In')); ?> </button>
                      </div>
                  </form>
                </div>
                <!-- /End replace -->
        ...
        <div class="mt-8 text-center">
                            <p class="text-sm">Don`t have an account?<a href="<?php echo e(route('register')); ?>" class="text-yellow-500">&nbsp;&nbsp;<?php echo e(__('Sign Up')); ?></a></p>
                    </div>
    </div>

<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Project\datingapp\levana\resources\views/auth/login.blade.php ENDPATH**/ ?>