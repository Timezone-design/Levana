...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div class="flex justify-start lg:w-0 lg:flex-1">
            ...
            <h1 class="text-pink-450 text-3xl" id="logo">Levana</h1>
            </a>
        </div>
        ...
        <div class="pt-5 pb-6 px-5">
            ...
            <?php if(Route::has('login')): ?>
                <?php if(auth()->guard()->check()): ?>
                    <a href="<?php echo e(url('/home')); ?>" class="-m-3 p-3 flex items-center rounded-md hover:bg-gray-50">
                        <span class="ml-3 text-base font-medium text-gray-900">
                            Home
                        </span>
                    </a>
                    <form action="<?php echo e(url('/logout')); ?>" method="post" class="-m-3 p-3 flex items-center rounded-md hover:bg-gray-50">
                        <?php echo csrf_field(); ?>
                ...
                <?php else: ?>
                    <a href="<?php echo e(route('login')); ?>" class="-m-3 p-3 flex items-center rounded-md hover:bg-gray-50">
                        <span class="ml-3 text-base font-medium text-gray-900">
                            Login
                        </span>
                    </a>
                    ...
                    <?php if(Route::has('register')): ?>
                        <a href="<?php echo e(route('register')); ?>" class="-m-3 p-3 flex items-center rounded-md hover:bg-gray-50">
                            <span class="ml-3 text-base font-medium text-gray-900">
                                Register
                            </span>
                        </a>
...
<?php /**PATH D:\Project\datingapp\Laravel-dating-site\resources\views\welcome.blade.php ENDPATH**/ ?>